...
function CalculatorTable() {
  ...
  // });
  return (
    <div className="flex flex-col w-[350px] sm:w-[550px] md:w-[650px] xl:w-[850px] dark:bg-gray-800 rounded-xl">
      ...
      <div className="flex flex-row items-center justify-between pb-2 px-5 pt-3">
        <label className="text-sm sm:text-lg md:text-xl">Ticker Symbol</label>
        <input
          type="text"
          ...
          className="text-sm sm:text-lg md:text-xl rounded-md py-2 px-3 text-center text-black dark:text-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ></input>
      </div>
      <div className="flex flex-row items-center justify-between pb-2 px-5">
        <label className="text-sm sm:text-lg md:text-xl">
          Valuation Method
        </label>
        <input
          type="text"
          ...
          readOnly
          className="text-sm sm:text-lg md:text-xl rounded-md py-2 px-3 text-center border text-black border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-yellow-300 bg-white"
        ></input>
      </div>
      ...
      <div className="flex flex-row items-center justify-between pb-2 pt-3 px-5">
        ...
        <input
          ...
          className="text-sm sm:text-lg md:text-xl rounded-md py-2 px-3 text-center text-black border dark:text-white border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ></input>
      </div>
      <div className="flex flex-row items-center justify-between pb-2 px-5">
        <label className="text-sm sm:text-lg md:text-xl">
      ...
      <div className="flex flex-row items-center justify-between pb-2 pt-3 px-5">
        <label className="text-sm sm:text-lg md:text-xl">
          Free Cash Flow growth rate (Yr 1-5)
        </label>
        <input
          type="text"
      ...
      <div className="flex flex-row items-center justify-between pb-2 px-5">
        <label className="text-sm sm:text-lg md:text-xl">
          Free Cash Flow growth rate (Yr 6-10)
        </label>
        <input
          type="text"
      ...
      <div className="flex flex-row items-center justify-between pb-2 px-5">
        <label className="text-sm sm:text-lg md:text-xl">
          Free Cash Flow growth rate (Yr 11-20)
        </label>
        <input
          type="text"
      ...
      <div className="flex flex-row items-center justify-between pb-2 px-5 pt-3">
        <label className="text-sm sm:text-lg md:text-xl">Discount Rate</label>
        <input
          type="text"
      ...
      <div className="flex flex-row items-center justify-between pb-2 px-5">
        <label className="text-sm sm:text-lg md:text-xl">Current Year</label>
        <input
          type="text"
          placeholder="2025"
          readOnly
          className="text-sm sm:text-lg md:text-xl rounded-md py-2 px-3 text-center text-black border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-yellow-300 bg-white"
        ></input>
      </div>
    </div>
  );
